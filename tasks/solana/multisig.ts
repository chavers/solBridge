...
export async function createMultisig(
  ...
  const instruction3 = txBuilder.getInstructions()[3];
  instruction3.programId = umiPublicKey(TOKEN_2022_PROGRAM_ID.toBase58());

  console.log("txBuilder", txBuilder.getInstructions()[3]);
